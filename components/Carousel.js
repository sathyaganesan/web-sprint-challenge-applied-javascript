...
function caro() {
  ...
  // Element create:
  const carosl = document.createElement('div');
  const lftbtn = document.createElement('div');
  const img1 = document.createElement('img');
  const img2 = document.createElement('img');
  const img3 = document.createElement('img');
  const img4 = document.createElement('img');
  const ritbtn = document.createElement('div');

  //Adding Classlist:
  carosl.classList.add('carousel');
  ...
  ritbtn.classList.add('right-button');

  // Appending Element:
  caroContainer.appendChild(carosl);
  carosl.appendChild(lftbtn);
  carosl.appendChild(img1);
  carosl.appendChild(img2);
  carosl.appendChild(img3);
  carosl.appendChild(img4);
  carosl.appendChild(ritbtn);
